...
meeting_7= Meeting.create!(name: "Metronomy", address: "50 Avenue Jean Alfonséa, 33270 Floirac", start_date: "23/09/16", end_date: "23/09/16", start_time: DateTime.new(2023,9,25), end_time: DateTime.new(2023,9,25))
...
meeting_9= Meeting.create!(name: "Match ouverture, CDM Rugby", address: "13 Cours Georges Clemenceau, 33000 Bordeaux", start_date: "23/09/08", end_date: "23/09/08", start_time: DateTime.new(2023,9,30), end_time: DateTime.new(2023,9,30))
meeting_9= Meeting.create!(name: "France-Uruguay, CDM Rugby", address: "13 Cours Georges Clemenceau, 33000 Bordeaux", start_date: "23/09/14", end_date: "23/09/14", start_time: DateTime.new(2023,9,30), end_time: DateTime.new(2023,9,30))
